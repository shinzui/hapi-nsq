...
exports.register = function(server, options, next) {
  ...
  server.ext('onPreStop', function(_server, _next) {
    ...
    server.log(['nsq'], 'closing writer connected to ' + writer.nsqdHost + ' on port ' + writer.nsqdPort)
  ...
  writer.on('ready', function () {
    ...
    server.log(['nsq'], 'nsq writer connected to ' + writer.nsqdHost + ' on port ' + writer.nsqdPort)
